...
<div class="mantenimiento-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Actualizar'), ['update', 'id' => $model->Id_Mantenimiento], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Eliminar'), ['delete', 'id' => $model->Id_Mantenimiento], [
...
//            'Id_Ubicacion',
            ...
            'Observacion',
//            'Id_Ayudante',
            'idAyudante.Descripcion:text:Ayudante',
        ],
    ]) ?>
